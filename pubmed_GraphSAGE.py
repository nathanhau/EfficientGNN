...
train_label = labels[train_nids]
valid_label = labels[valid_nids]
test_label = labels[test_nids]
...
model = Model(in_feats, n_hidden, n_classes, n_layers, k, activation, bias=True, dropout=dropout, iso=True, adj=graph.adj()).to(device)
print(model)
