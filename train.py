...
from models import DGC, dgc_precompute
...
def gen_model(args):
    model = DGC(in_feats, n_classes, args.T, args.K)
    return model
...
def main():
    ...
    argparser = argparse.ArgumentParser("DGC on OGBN-Arxiv", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    ...
    argparser.add_argument('--dataset', type=str, default="cora",
                        help='Dataset to use.')
    argparser.add_argument('--lr', type=float, default=0.156,
                        help='Initial learning rate.')
    argparser.add_argument('--wd', type=float, default=3.544e-5,
                        help='Weight decay (L2 loss on parameters).')
    argparser.add_argument('--n-epochs', type=int, default=100,
    ...
    argparser.add_argument('--trials', type=int, default=10, help='Run multiple trails for fair evaluation')
    # DGC parameters
    argparser.add_argument('--T', type=float, default=5.27,
                        help='real-valued diffusion terminal time.')
    argparser.add_argument('--K', type=int, default=250,
